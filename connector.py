...
out.close()
#----------
n=open('type/noun.txt','w')
v=open('type/verb.txt','w')
adv=open('type/adverb.txt','w')
adj=open('type/adjective.txt','w')
num=open('type/numeral.txt','w')
prn=open('type/pronoun.txt','w')
det=open('type/determiner.txt','w')
pro=open('type/propername.txt','w')
#e=open('type/e\'s.txt','w')
#---------
f=open('releaseresult.txt','r')
